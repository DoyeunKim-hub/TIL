...
> 헤더는 제목을 표한할 때 사용합니다. 단순히 글자의 크기를 표한하는 것이 아닌 의미론적인 중요도를 나타냅니다.
...
> 목록을 나열할 때 사용합니다. 순서가 필요한 항목과 그렇지 않은 항목으로 구분할 수 있습니다. 순서가 있는 항목 아래 순서가 없는 항목을 지점할 수 있으며 그 반대도 가능합니다.
